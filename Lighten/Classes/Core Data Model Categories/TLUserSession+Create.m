...
@implementation TLUserSession (Create)
+(void)createUserSessionWithInfo: (NSDictionary *) info
{
    ...
    object = [NSEntityDescription insertNewObjectForEntityForName:@"UserSession" inManagedObjectContext:managedObjectContext];
